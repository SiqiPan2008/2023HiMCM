...
\begin{abstract}
	...
	\vspace{0.5cm}	
	In this paper, we design a \textbf{Dandelion Spread Model} by using the Monte Carlo method.  
...
\vspace{-1cm}
It is always a dreamlike scene to see dandelion seeds flying on a summer day.  All those little parachutes drift in the air, slowly and gently, through a beam of light, like angels from the sky.
