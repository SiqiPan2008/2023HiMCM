			...
			
			{
				\fontsize{10}{14}\selectfont
				{
					\begin{longtable}{ccccccc}
						\caption{Environmental variable values for six locations}
						\label{tb:locs}\\
						\toprule
	...
	\subsection{Dandelion Spread Results}
		...
		\subsubsection{Results}
			...
			\begin{figure}
				...
				\caption{Number and mean distance of dandelions in Florida when simulation starts at different dates}
				\label{fig:start}
			\end{figure}
			
			{
				\fontsize{10}{14}\selectfont
				{
					\begin{longtable}{ccccccccccccc}
						\caption{Number of dandelions at six locations when simulation starts at different dates}
						\label{tb:start}\\
						\toprule
			...
			
			{
				\fontsize{10}{14}\selectfont
				{
					\begin{longtable}{cccccccc}
						\caption{Statistics of the distribution of the number of dandelions at six locations}
			...
			
			{
				...
				{
					\begin{longtable}{cccccccc}
						\caption{Statistics of the distribution of the mean distance at six locations}
	...
	\subsection{Model Description}
		...
		
		{
			...
			\begin{longtable}{p{0.2in}p{1.5in}p{4.3in}}
				...
				\caption{Factors considered for the impact factor}
				\label{tb:factors}\\
		...
		
		{
			\fontsize{10}{18}\selectfont
			{
				\begin{longtable}{c|ccccccccc|ccccc||cccc}
					...
					\caption{Comparison matrix of AHP}
					\label{tb:mat}\\
...

		{
			...
			{
				\begin{longtable}{cccccccc}
					\caption{Consistency test of global and local comparison matrices}
	...
	
		{
			\fontsize{10}{14}\selectfont
			{
				\begin{longtable}{c|ccccccccc}
					\caption{Weights of global and local factors}
					\label{tb:weights}\\
		...
		
		{
			\fontsize{10}{14}\selectfont
			{
				\begin{longtable}{cccccc}
					\caption{Rankings of selected plants}
					\label{tb:ranks}\\
