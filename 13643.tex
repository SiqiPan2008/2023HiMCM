...
\section{Dandelion Spread Model}
	...
	\subsection{Environmental Factors}
		...
		\subsubsection{Temperature}
			...
			The points on this curve should satisfy the following two conditions:
		...
		\subsubsection{Wind and Dispersal}
			...
			For the distance of seed dispersal, we consider two types of wind, horizontal wind and updraft.  See Figure \ref{fig:dispersal} for the two different types of wind.
