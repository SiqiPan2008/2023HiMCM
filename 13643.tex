...
\section{Dandelion Spread Model}
	...
	\subsection{Assumptions and Justifications}
		...
		\begin{enumerate}
			...
			\item The dandelion is located at the midpoint of an edge of a square field, which has dimensions of 100m$\times$100m (1 hectare).  When seeds are blown out of the field, they are neglected.
			\vspace{-0.125in}
			\begin{description}
			...
			\item Wind direction is uniformly distributed from $0^\circ$ to $360^\circ$.
			\vspace{-0.125in}
			\begin{description}
