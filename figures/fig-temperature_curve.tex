...
\begin{document}
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\draw[<->, line width=0.5] (3.25, 0.8) -- (3.25, 3.2);
			\addplot [black, thick] {-2.4*cos(deg(x)*4*pi/13)+0.8};
			\draw[dashed] (6.5, 0) -- (6.5, -1.6);
			\fill[] (3.25, 0.8) circle (0.05);
			\fill (3.25, 3.2) circle (0.05);
			\fill (6.5, -1.6) circle (0.05);
			\fill (0, -1.6) circle (0.05);
			\fill (1.625, 0.8) circle (0.05);
			\fill (4.875, 0.8) circle (0.05);
